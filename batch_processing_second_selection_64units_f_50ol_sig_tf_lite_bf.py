...
fs=16000
# load models
interpreter_1 = tflite.Interpreter(model_path='64units_f_50ol_sig.tflite', experimental_preserve_all_tensors=True)
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(model_path='64units_f_50ol_sig.tflite', experimental_preserve_all_tensors=True)
interpreter_2.allocate_tensors()
interpreter_3 = tflite.Interpreter(model_path='64units_f_50ol_sig.tflite', experimental_preserve_all_tensors=True)
...
prefix = 'output/snr_(6)_MTR_TF_lite_bf_64units_f_50ol_sig_{}sec.wav'
d = { "{}": str(ss)}
