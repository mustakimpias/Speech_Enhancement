...
# write to .wav file
if bf==1:
    sf.write(f'output/snr_(6)_MTR_TF_lite_f_by_f_BF_64units_f_50ol_sig.wav', out_file, fs)
else:
    sf.write(f'output/snr_(6)_MTR_TF_lite_64units_f_50ol_sig.wav', out_file, fs)
